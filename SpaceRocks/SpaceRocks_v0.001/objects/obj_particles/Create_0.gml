...
partTypeShipDash = part_type_create();
part_type_sprite(partTypeShipDash, spr_ship, false,
false, false);
part_type_size(partTypeShipDash,.8,1,0,0);
part_type_life(partTypeShipDash,10,20);
part_type_alpha3(partTypeShipDash,.8,.4,0);
//with(obj_ship){
part_type_direction(partTypeShipDash,0,359,0,false);
part_type_orientation(partTypeShipDash,0,359,1,false,false);
part_type_speed(partTypeShipDash,3,2.4,-0.02,0);
//}
